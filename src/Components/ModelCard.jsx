...
const ModelCard = ({model}) => {
    return (
      ...
      <div className="p-5 pb-7">
        <h3 className="text-xl dark:text-black font-semibold mb-2">{model.name}</h3>
        ...
        <Link to={`/models-details/${model._id}`} className="btn w-full bg-[#24282c] text-white font-medium py-2 px-4 rounded-lg transition">
          View Details
        </Link>
      </div>
    </div>
